...
## Recent Changes  
- August 14, 2025: **KINGSTON_TOURNAMENT_RULES_COMPLETE** - Implementat sistemul complet de regulament pentru turneul Kingston x HyperX - Supercup Season 1. Adăugat secțiune detaliată cu regulile roster-ului (max 10 jucători: 5 titulari + 5 substitute, roster fix pe durata turneului), conduita în meci (tech lose pentru absentă, delay 15-30 min pentru probleme tehnice), reguli de comportament (warn pentru insulte, ban pentru lipsa de respect), și anti-cheat & fair play (interzicerea strict a cheat-urilor și bug-urilor). Secțiunea include notificare importantă despre sancțiuni severe pentru încălcarea regulilor.
