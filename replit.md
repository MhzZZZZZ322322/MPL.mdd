...
## Recent Changes  
- August 14, 2025: **HEROSLIDER_PERFECT_IMAGE_FITTING_OPTIMIZED** - Optimizat complet HeroSlider pentru încadrarea perfectă a imaginilor: imaginile acoperă întreaga zonă (object-cover), conținut centrat vertical și orizontal, text cu shadow îmbunătățit pentru vizibilitate, butoane mai mari cu styling profesional, indicatori repositionați. Integrată imaginea oficială "Supercup Season 1" pe prima poziție în slider cu design elegant.
- August 14, 2025: **KINGSTON_HOMEPAGE_PROMOTION_COMPLETE** - Promovat turneul Kingston pe pagina principală: HeroSlider transformat în adevărat slider cu 2 slide-uri (Kingston primul, HATOR al doilea), cronologie actualizată cu 4 turnee în ordine cronologică corectă (MPL Pilot Cup martie, HATOR CS League aprilie-iunie, HATOR CUP - ROPL x MPL august activ, Kingston august-septembrie activ). Ambele turnee active marcate vizual cu highlight special și butoane "ÎNSCRIE-TE ACUM". Layout adaptat pentru grid 4 coloane pe ecrane mari.
