...
## Recent Changes  
- August 14, 2025: **KINGSTON_TOURNAMENT_RULES_VERIFIED_COMPLETE** - Verificat și corectat complet regulamentul turneului Kingston pentru a corespunde exact cu textul furnizat. Actualizat toate textele pentru consistență: "5 în roster + 5 în substitute", regula exactă pentru probleme tehnice cu anunțare prealabilă, fraza corectă despre banarea lentă a hărților, și formularea precisă pentru critica evenimentului. Actualizat și componentele de înregistrare și traducerile pentru a reflecta regulamentul corect (maximum 10 jucători în loc de 7).
