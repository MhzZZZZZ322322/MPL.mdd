...
## Recent Changes  
- August 14, 2025: **KINGSTON_HOMEPAGE_PROMOTION_COMPLETE** - Promovat turneul Kingston pe pagina principală: HeroSlider transformat în adevărat slider cu 2 slide-uri (Kingston primul, HATOR al doilea), cronologie actualizată cu 4 turnee în grid responsiv (MPL Pilot Cup, Kingston activ cu highlight special, HATOR CUP - ROPL x MPL, HATOR CS League). Corectate datele HATOR CUP: 23-24 august 2025, prize pool 5500 RON. Kingston marcat vizual ca turneu activ cu butoane "ÎNSCRIE-TE ACUM". Layout adaptat pentru grid 4 coloane pe ecrane mari.
