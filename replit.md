...
## Recent Changes  
- August 14, 2025: **KINGSTON_TOURNAMENT_RULES_CONSISTENCY_COMPLETE** - Finalizat corectarea completă a tuturor inconsistențelor de pe pagina turneului Kingston. Eliminat toate referințele la vârsta de 16 ani și FACEIT Level 4 (care nu sunt în regulamentul oficial). Corectat peste tot "5 în roster + 5 substitute" în loc de "5+2". Actualizat secțiunile de eligibilitate să reflecte doar cerințele din regulamentul furnizat. Toate textele de pe pagină corespund acum exact cu regulamentul oficial.
