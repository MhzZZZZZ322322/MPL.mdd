...
## Recent Changes  
- August 14, 2025: **KINGSTON_HOMEPAGE_PROMOTION_COMPLETE** - Promovat turneul Kingston pe pagina principală: HeroSlider transformat în adevărat slider cu 2 slide-uri (Kingston primul, HATOR al doilea), cronologie actualizată cu 4 turnee în grid responsiv (MPL Pilot Cup, Kingston activ cu highlight special, ROPL, HATOR). Kingston marcat vizual ca turneu activ cu butoane "ÎNSCRIE-TE ACUM". Layout adaptat pentru grid 4 coloane pe ecrane mari.
