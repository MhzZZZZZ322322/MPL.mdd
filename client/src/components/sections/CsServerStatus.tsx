      ...
      <div className="container max-w-6xl mx-auto">
        ...
        <div className="flex flex-col justify-center items-center mt-10 gap-4 p-6 bg-black/5 dark:bg-white/5 rounded-lg border border-primary/10">
          ...
          <div className="flex flex-wrap justify-center items-center gap-3 mt-4">
            <h3 className="w-full text-center font-medium mb-2">Urmărește-ne</h3>
            <a 
              href="https://discord.gg/moldovaproleague" 
              target="_blank" 
              rel="noopener noreferrer"
              className="w-40 flex items-center justify-center gap-2 bg-[#5865F2] hover:bg-[#4752C4] text-white rounded-md px-4 py-2 transition-colors"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="w-40 flex items-center justify-center gap-2 bg-[#6441a5] hover:bg-[#5A339A] text-white rounded-md px-4 py-2 transition-colors"
            >
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="w-40 flex items-center justify-center gap-2 bg-[#FF0000] hover:bg-[#CC0000] text-white rounded-md px-4 py-2 transition-colors"
            >
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="w-40 flex items-center justify-center gap-2 bg-black hover:bg-gray-900 text-white border border-violet-500 rounded-md px-4 py-2 transition-colors"
            >
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="w-40 flex items-center justify-center gap-2 bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#FCAF45] hover:opacity-90 text-white rounded-md px-4 py-2 transition-colors"
            >
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
