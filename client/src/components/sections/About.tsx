...
import { Trophy, Users, Medal, LucideTerminal, History, Sparkles } from 'lucide-react';
      ...
      <div className="absolute inset-0 opacity-5 z-0">
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
          <pattern id="pattern-circles" x="0" y="0" width="50" height="50" patternUnits="userSpaceOnUse" patternContentUnits="userSpaceOnUse">
            <circle id="pattern-circle" cx="10" cy="10" r="1.6257413380501518" fill="#a855f7"></circle>
          </pattern>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-16">
            <div data-aos="fade-up">
              <h3 className="font-orbitron text-2xl mb-8 text-white text-center">Cronologia MPL</h3>
            </div>
                ...
                {timeline.map((item, index) => (
                  ...
                  >
                    <div className="flex-1 md:max-w-sm bg-darkGray/50 p-6 rounded-lg border border-primary/10 hover:shadow-[0_0_15px_rgba(139,92,246,0.2)] transition-all">
                      ...
                      <div className="mb-2 text-secondary font-bold">{item.year}</div>
          ...
          <div>
            <div data-aos="fade-up">
              <h3 className="font-orbitron text-2xl mb-8 text-white text-center">Misiunea noastră</h3>
            </div>
