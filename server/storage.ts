...
export class MemStorage implements IStorage {
  ...
  private initializeData() {
    ...
    // Add all team members from tournament data
    const allTeamMembers = [
      ...
      // Team 2 - BPSP
      { teamId: 2, nickname: "Mkee", role: "captain", position: "main" },
      { teamId: 2, nickname: "strky_", role: "player", position: "main" },
      { teamId: 2, nickname: "-formet-", role: "player", position: "main" },
      { teamId: 2, nickname: "KureaCYA", role: "player", position: "main" },
      { teamId: 2, nickname: "Bandajel", role: "player", position: "main" },
      ...
      // Team 5 - Bobb3rs
      { teamId: 5, nickname: "ZanTX", role: "captain", position: "main" },
      ...
      // Team 6 - Brigada Meteor
      { teamId: 6, nickname: "yeahmen0", role: "captain", position: "main" },
      { teamId: 6, nickname: "cacioc", role: "player", position: "main" },
      { teamId: 6, nickname: "RoyalD", role: "player", position: "main" },
      { teamId: 6, nickname: "_AM", role: "player", position: "main" },
      { teamId: 6, nickname: "neirhe", role: "player", position: "main" },
      { teamId: 6, nickname: "Smali_", role: "player", position: "reserve" },
      ...
      // Team 9 - Ciocana Esports
      { teamId: 9, nickname: "CoMMaNDeR_MD", role: "captain", position: "main" },
      { teamId: 9, nickname: "f1ke_soft", role: "player", position: "main" },
      { teamId: 9, nickname: "FraGGvesta", role: "player", position: "main" },
      { teamId: 9, nickname: "HamsteR_TR", role: "player", position: "main" },
      { teamId: 9, nickname: "tr1cketw", role: "player", position: "main" },
      { teamId: 9, nickname: "xxx", role: "player", position: "reserve" },
      { teamId: 9, nickname: "Shutting", role: "player", position: "reserve" },

      // Team 10 - Ciocălău Team
      { teamId: 10, nickname: "xen0", role: "captain", position: "main" },
      { teamId: 10, nickname: "Esantorix", role: "player", position: "main" },
      { teamId: 10, nickname: "kryzw", role: "player", position: "main" },
      { teamId: 10, nickname: "w1ks", role: "player", position: "main" },
      { teamId: 10, nickname: "fartune", role: "player", position: "main" },

      // Team 11 - Cipok
      { teamId: 11, nickname: "gufyX", role: "captain", position: "main" },
      { teamId: 11, nickname: "Serhiok1", role: "player", position: "main" },
      { teamId: 11, nickname: "Luk4x", role: "player", position: "main" },
      { teamId: 11, nickname: "drazzer", role: "player", position: "main" },
      { teamId: 11, nickname: "TenZ", role: "player", position: "main" },
      { teamId: 11, nickname: "alexa190y", role: "player", position: "reserve" },

      // Team 12 - Coli
      { teamId: 12, nickname: "CADE_", role: "captain", position: "main" },
      { teamId: 12, nickname: "BastionBG", role: "player", position: "main" },
      { teamId: 12, nickname: "Vali_rux_", role: "player", position: "main" },
      { teamId: 12, nickname: "OrangeFlash", role: "player", position: "main" },
      { teamId: 12, nickname: "DedInside_", role: "player", position: "main" },

      // Team 13 - Crasat
      { teamId: 13, nickname: "greyto", role: "captain", position: "main" },
      { teamId: 13, nickname: "danducu", role: "player", position: "main" },
      { teamId: 13, nickname: "darko", role: "player", position: "main" },
      { teamId: 13, nickname: "faKe1", role: "player", position: "main" },
      { teamId: 13, nickname: "peeeew", role: "player", position: "main" },
      { teamId: 13, nickname: "flockyy", role: "player", position: "reserve" },

      // Team 14 - Cucumba
      { teamId: 14, nickname: "liveez", role: "captain", position: "main" },
      { teamId: 14, nickname: "elecTRO", role: "player", position: "main" },
      { teamId: 14, nickname: "eZ4ZLYY", role: "player", position: "main" },
      { teamId: 14, nickname: "Sandu", role: "player", position: "main" },
      { teamId: 14, nickname: "Sh4dY", role: "player", position: "main" },
      { teamId: 14, nickname: "Redfox", role: "player", position: "reserve" },

      // Team 15 - Flux Line
      { teamId: 15, nickname: "albinutza22", role: "captain", position: "main" },
      { teamId: 15, nickname: "ezmoneywins", role: "player", position: "main" },
      { teamId: 15, nickname: "fkneko", role: "player", position: "main" },
      { teamId: 15, nickname: "kap1tosha", role: "player", position: "main" },
      { teamId: 15, nickname: "neaNN", role: "player", position: "main" },

      // Team 16 - GoldenFive
      { teamId: 16, nickname: "DRACU23", role: "captain", position: "main" },
      { teamId: 16, nickname: "d1sconnected", role: "player", position: "main" },
      { teamId: 16, nickname: "Sliinky", role: "player", position: "main" },
      { teamId: 16, nickname: "tedi9", role: "player", position: "main" },
      { teamId: 16, nickname: "Darius_MD", role: "player", position: "main" },

      // Team 17 - Into The Breach
      { teamId: 17, nickname: "beeeear1337", role: "captain", position: "main" },
      { teamId: 17, nickname: "BeTTer_ThanU", role: "player", position: "main" },
      { teamId: 17, nickname: "Shizom", role: "player", position: "main" },
      { teamId: 17, nickname: "Lol_mxn", role: "player", position: "main" },
      { teamId: 17, nickname: "ERASE_", role: "player", position: "main" },

      // Team 18 - Japon
      { teamId: 18, nickname: "TomasZ", role: "captain", position: "main" },
      { teamId: 18, nickname: "Ixolite", role: "player", position: "main" },
      { teamId: 18, nickname: "KeM3Ra", role: "player", position: "main" },
      { teamId: 18, nickname: "V1Kki", role: "player", position: "main" },
      { teamId: 18, nickname: "CristianSir_", role: "player", position: "main" },

      // Team 20 - Killuminati
      { teamId: 20, nickname: "StiLLin", role: "captain", position: "main" },
      { teamId: 20, nickname: "SECU", role: "player", position: "main" },
      { teamId: 20, nickname: "tavi369", role: "player", position: "main" },
      { teamId: 20, nickname: "Haiduki", role: "player", position: "main" },
      { teamId: 20, nickname: "aKOLYT", role: "player", position: "main" },
      { teamId: 20, nickname: "TheBeasT", role: "player", position: "reserve" },

      // Team 21 - KostujaniKlinik
      { teamId: 21, nickname: "Th3c0br4", role: "captain", position: "main" },
      { teamId: 21, nickname: "b1indu", role: "player", position: "main" },
      { teamId: 21, nickname: "cUbel", role: "player", position: "main" },
      { teamId: 21, nickname: "nyk0Lash", role: "player", position: "main" },
      { teamId: 21, nickname: "4uKers", role: "player", position: "main" },

      // Team 22 - LYSQ
      { teamId: 22, nickname: "sTyX", role: "captain", position: "main" },
      { teamId: 22, nickname: "fAtaLGod", role: "player", position: "main" },
      { teamId: 22, nickname: "xXElitaXx", role: "player", position: "main" },
      { teamId: 22, nickname: "Bogdin_05", role: "player", position: "main" },
      { teamId: 22, nickname: "DarkD", role: "player", position: "main" },

      // Team 23 - La Passion
      { teamId: 23, nickname: "toasT", role: "captain", position: "main" },
      { teamId: 23, nickname: "ICEBEAER", role: "player", position: "main" },
      { teamId: 23, nickname: "a_simple_loser", role: "player", position: "main" },
      { teamId: 23, nickname: "Aky007", role: "player", position: "main" },
      { teamId: 23, nickname: "Sh1pper", role: "player", position: "main" },

      // Team 24 - Lean Vision
      { teamId: 24, nickname: "NICKforb1", role: "captain", position: "main" },
      { teamId: 24, nickname: "stalkah", role: "player", position: "main" },
      { teamId: 24, nickname: "s1lly", role: "player", position: "main" },
      { teamId: 24, nickname: "vd3", role: "player", position: "main" },
      { teamId: 24, nickname: "L1NKin", role: "player", position: "main" },

      // Team 25 - Legalize
      { teamId: 25, nickname: "Triksterr", role: "captain", position: "main" },
      { teamId: 25, nickname: "AresFPS", role: "player", position: "main" },
      { teamId: 25, nickname: "Maxxer", role: "player", position: "main" },
      { teamId: 25, nickname: "zR1", role: "player", position: "main" },
      { teamId: 25, nickname: "RAGE", role: "player", position: "main" },

      // Team 26 - LitEnergy
      { teamId: 26, nickname: "Ult1mate", role: "captain", position: "main" },
      { teamId: 26, nickname: "Dextro", role: "player", position: "main" },
      { teamId: 26, nickname: "DeTox", role: "player", position: "main" },
      { teamId: 26, nickname: "AxelDiamond", role: "player", position: "main" },
      { teamId: 26, nickname: "GGS", role: "player", position: "main" },

      // Team 27 - Muligambia
      { teamId: 27, nickname: "SirMiky", role: "captain", position: "main" },
      { teamId: 27, nickname: "l1ttlem0nk3y", role: "player", position: "main" },
      { teamId: 27, nickname: "rk9", role: "player", position: "main" },
      { teamId: 27, nickname: "Keyl1", role: "player", position: "main" },
      { teamId: 27, nickname: "HiddeR", role: "player", position: "main" },

      // Team 28 - Neo Egoist League
      { teamId: 28, nickname: "s1lv3r", role: "captain", position: "main" },
      { teamId: 28, nickname: "mok4", role: "player", position: "main" },
      { teamId: 28, nickname: "jqke", role: "player", position: "main" },
      { teamId: 28, nickname: "NoNameE3", role: "player", position: "main" },
      { teamId: 28, nickname: "MrB4nK", role: "player", position: "main" },

      // Team 29 - Onyx
      { teamId: 29, nickname: "crni", role: "captain", position: "main" },
      { teamId: 29, nickname: "KING15", role: "player", position: "main" },
      { teamId: 29, nickname: "Ady", role: "player", position: "main" },
      { teamId: 29, nickname: "Dan1eL", role: "player", position: "main" },
      { teamId: 29, nickname: "S1mpleOfMoldova", role: "player", position: "main" },

      // Team 30 - RCBVR
      { teamId: 30, nickname: "BoSs7", role: "captain", position: "main" },
      { teamId: 30, nickname: "Sandr100", role: "player", position: "main" },
      { teamId: 30, nickname: "DanielS", role: "player", position: "main" },
      { teamId: 30, nickname: "L0nqu", role: "player", position: "main" },
      { teamId: 30, nickname: "NeX7SCAM", role: "player", position: "main" },

      // Team 31 - Robotaim
      { teamId: 31, nickname: "alexPROHAha", role: "captain", position: "main" },
      { teamId: 31, nickname: "aidoka", role: "player", position: "main" },
      { teamId: 31, nickname: "ixchel0", role: "player", position: "main" },
      { teamId: 31, nickname: "unKn0wn_", role: "player", position: "main" },
      { teamId: 31, nickname: "Shurikenn", role: "player", position: "main" },

      // Team 33 - Shashlik
      { teamId: 33, nickname: "BURAZERU", role: "captain", position: "main" },
      { teamId: 33, nickname: "KZ_gigi_MD", role: "player", position: "main" },
      { teamId: 33, nickname: "stihl", role: "player", position: "main" },
      { teamId: 33, nickname: "temakaZZZ", role: "player", position: "main" },
      { teamId: 33, nickname: "ZOV", role: "player", position: "main" },
      ...
      // Team 36 - WenDeagle
      { teamId: 36, nickname: "RdTm_7", role: "captain", position: "main" },
      { teamId: 36, nickname: "AleX_RO", role: "player", position: "main" },
      { teamId: 36, nickname: "S1m1k", role: "player", position: "main" },
      { teamId: 36, nickname: "Nxce", role: "player", position: "main" },
      { teamId: 36, nickname: "EnzoTCS", role: "player", position: "main" },

      // Team 37 - Wenzo
      { teamId: 37, nickname: "enzo", role: "captain", position: "main" },
      { teamId: 37, nickname: "UwU_", role: "player", position: "main" },
      { teamId: 37, nickname: "Vint", role: "player", position: "main" },
      { teamId: 37, nickname: "eX", role: "player", position: "main" },
      { teamId: 37, nickname: "aRtyyy", role: "player", position: "main" },

      // Team 38 - X-one
      { teamId: 38, nickname: "Raizen_", role: "captain", position: "main" },
      { teamId: 38, nickname: "DanieLL47", role: "player", position: "main" },
      { teamId: 38, nickname: "Maty", role: "player", position: "main" },
      { teamId: 38, nickname: "NVK_laMa", role: "player", position: "main" },
      { teamId: 38, nickname: "GaMeR", role: "player", position: "main" },

      // Team 39 - XPloison
      { teamId: 39, nickname: "Mihai", role: "captain", position: "main" },
      { teamId: 39, nickname: "kEo", role: "player", position: "main" },
      { teamId: 39, nickname: "Andry", role: "player", position: "main" },
      { teamId: 39, nickname: "AJzzze", role: "player", position: "main" },
      { teamId: 39, nickname: "LexusLx570", role: "player", position: "main" }
    ];
